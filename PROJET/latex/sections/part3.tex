...
\paragraph{Caractéristiques} \begin{itemize}[left=0pt]
  ...
  \item Annotations pixel-level tous les 5 frames ($\approx$ 6 FPS), objets multiples par clip (jusqu'à 5).
...
\paragraph{Caractéristiques} \begin{itemize}[left=0pt]
  \item 330k images (200k annotées), 80 catégories ; \textasciitilde1.5M instances ($\approx$ 47 objets/image).
